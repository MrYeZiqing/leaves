module.exports = {
    ...
    'plugins': [ // ESLint 支持使用第三方插件。在使用插件之前，你必须使用 npm 安装它。
        'react' // eslint-plugin-react插件,npm install eslint-plugin-react --save-dev
    ],
    'settings': {
        'react': {
    ...
    'globals': { // 使用 globals 指出你要使用的全局变量
        ...
        'Uploader': false,
        'fileUploadUrl': false,
        'equipmentPageUrl': false,
        'showFuncDetail': false,
        'showEditFuncValueDesc': false,
        'chosenGlobalSettings': false,
        'showEditBrand': false,
        'productPageUrl': false,
        'showEditDeviceName': false,
        'userIdGlobal': false,
    ...
    'rules': {
        ...
        'react/require-render-return':'error' // 在es5和es6语法的render函数中，需要有return返回值
    }
};
